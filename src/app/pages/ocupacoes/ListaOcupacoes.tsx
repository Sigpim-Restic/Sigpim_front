            ...
            <TableBody>
              ...
              {!loading && filtradas.map((o) => (
                <TableRow key={o.id} className="hover:bg-gray-50/80">
                  <TableCell className="font-mono text-xs font-semibold text-[#1351B4]">#{o.idImovel}</TableCell>
                  ...
                  <TableCell className="text-xs text-gray-600">{o.nivelOcupacao || "—"}</TableCell>
