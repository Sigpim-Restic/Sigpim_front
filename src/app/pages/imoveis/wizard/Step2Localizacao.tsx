...
export function CadastroImovelStep2() {
  ...
  // No field is mandatory for pre-registration.
  ...
  const handleBack = () => navigate("/imoveis/novo/etapa-1");
  ...
  return (
    <WizardLayout currentStep={2} onNext={handleNext} onBack={handleBack}>
      <div className="p-6 space-y-6">
        <div>
          <h3 className="text-lg font-semibold text-gray-900">Localização</h3>
          <p className="text-sm text-gray-600 mt-1">
            Endereço e coordenadas do imóvel — todos os campos são opcionais no pré-cadastro
          </p>
        </div>
